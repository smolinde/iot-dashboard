...
This error occurred because the WLAN name that you provided in the configuration file is invalid, because of one of the following three reasons:
...
Please make sure that your WLAN name is inside of double quotation marks (e.g., "MySecureWLAN") and fulfills all the previously mentioned aspects.
